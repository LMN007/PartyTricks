...
public class ParticleSystem {
  ...
  int m_groupCount;
  public ParticleGroup m_groupList;
...
//    assert(d2 != 0);
  ...
  public void updateContacts(boolean exceptZombie) {
    ...
    Arrays.sort(m_proxyBuffer, 0, m_proxyCount);//m_proxyBuffer, 0, m_proxyCount);=============
    m_contactCount = 0;
    int c_index = 0;
  ...
  public void setParticleRadius(float radius) {//设置粒子系统中粒子的半径
    m_particleDiameter = 2 * radius;
    m_squaredDiameter = m_particleDiameter * m_particleDiameter;
    m_inverseDiameter = 1 / m_particleDiameter;
  }

  public void setParticleDensity(float density) {//设置粒子的密度
    m_density = density;
    m_inverseDensity = 1 / m_density;
  }

  public float getParticleDensity() {//获取粒子的密度
    return m_density;
  }

  public void setParticleGravityScale(float gravityScale) {//设置重力系数
    m_gravityScale = gravityScale;
  }

  public float getParticleGravityScale() {//获取重力系数
    return m_gravityScale;
  }

  public void setParticleDamping(float damping) {//设置潮湿因子
    m_dampingStrength = damping;
  }

  public float getParticleDamping() {//获取潮湿因子
    return m_dampingStrength;
  }

  public float getParticleRadius() {//获取粒子系统中粒子的半径
  ...
  public Vec2[] getParticlePositionBuffer() {//获取粒子系统中所有粒子的位置缓冲区
    return m_positionBuffer.data;
  }

  public Vec2[] getParticleVelocityBuffer() {//获取粒子系统中所有粒子的速度缓冲区
  ...
  public void setParticlePositionBuffer(Vec2[] buffer, int capacity) {///设置粒子系统中所有粒子的位置
    setParticleBuffer(m_positionBuffer, buffer, capacity);
  }

  public void setParticleVelocityBuffer(Vec2[] buffer, int capacity) {//设置粒子系统中所有粒子的速度
  ...
  public int getParticleGroupCount() {//获取粒子群的数量
    return m_groupCount;
  }

  public ParticleGroup[] getParticleGroupList() {//获取粒子群列表
    return m_groupBuffer;
  }

  public int getParticleCount() {//获取粒子数
    return m_count;
  }
   ...
   * @param point2
   */
  public void raycast(ParticleRaycastCallback callback, final Vec2 point1, final Vec2 point2) {//对粒子系统进行光线检测
    if (m_proxyCount == 0) {
      return;
    }
    int firstProxy =
