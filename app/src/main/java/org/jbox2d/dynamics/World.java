...
public class World {
   ...
   */
  public void step(float dt, int velocityIterations, int positionIterations) {// int
    stepTimer.reset();
    tempTimer.reset();
    ...
    step.dt = dt;
    step.velocityIterations = (int) velocityIterations;
    step.positionIterations = (int) positionIterations;
    if (dt > 0.0f) {
      step.inv_dt = 1.0f / dt;
    } else {
      step.inv_dt = 0.0f;
